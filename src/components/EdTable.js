...
function EdTable({ getEditableEducation, updateShowModal, educationalData, seteducationalData }) {
            ...
            <Table >
                <thead>
                    <tr>
                        ...
                        <th style={{ width: '250px', color: 'black' }}><Button variant="outline" className="add" onClick={() => { updateShowModal('add', true) }}>+</Button></th>
                    </tr>
                </thead>
                <tbody>
